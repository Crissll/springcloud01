...
public class ConsumerController {
    ...
    public ResponseEntity<R> consumer01(){
        ...
        ResponseEntity<R> entity = restTemplate.getForEntity(Url.PROVIDER_01, R.class);
    ...
    public R consumer02(){
        ...
        map.put("username", "张删");
        R r = restTemplate.getForObject(Url.PROVIDER_02, R.class, map);
    ...
    public R consumer03(@PathVariable String username){
        ...
        R r = restTemplate.getForObject(Url.PROVIDER_03, R.class, map);
        return r;
    }
    ...
    public R consumer04(){
        ...
        R r = restTemplate.postForObject(Url.PROVIDER_04, requestBody, R.class, ruiValu);
        r.put("consumer", 8001);
        return r;
    }
    ...
    public R consumer05(){
        ...
        R r = restTemplate.postForObject(Url.PROVIDER_05, requestBody, R.class, ruialu);
        return r;
    }
    ...
    public R consumer06(){
        ...
        ruialu.put("id", UUID.getUUID());
        ruialu.put("username", "张飞");
        restTemplate.put(Url.PROVIDER_06, requestBody,ruialu);
        return R.ok();
    }
    ...
    public R consumer07(){
        ...
        restTemplate.delete(Url.PROVIDER_07,ruialu);
        return R.ok();
    }
}
